...
describe('request mock', () => {
  ...
  describe('constructor', () => {
    ...
    describe('when response is Array', () => {
      it('should create a ResponseMock from each item only if every item is a response-like object', () => {
      ...
      it('should create a ResponseMock from whole array if every at least one item is not a response-like object', () => {
